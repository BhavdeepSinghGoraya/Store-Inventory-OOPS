...
################################################################################
## Form generated from reading UI file 'Processed_orders_window.ui'
##
...
class Ui_processed_order_form(object):
    def setupUi(self, processed_order_form):
        if not processed_order_form.objectName():
            processed_order_form.setObjectName(u"processed_order_form")
        processed_order_form.resize(1108, 530)
        self.gridLayout = QGridLayout(processed_order_form)
        self.gridLayout.setObjectName(u"gridLayout")
        self.pending_order_box = QGroupBox(processed_order_form)
        ...
        self.retranslateUi(processed_order_form)

        QMetaObject.connectSlotsByName(processed_order_form)
    # setupUi

    def retranslateUi(self, processed_order_form):
        processed_order_form.setWindowTitle(QCoreApplication.translate("processed_order_form", u"Grocery Store", None))
        self.pending_order_box.setTitle(QCoreApplication.translate("processed_order_form", u" Order List", None))
        ___qtablewidgetitem = self.orders_table.horizontalHeaderItem(0)
        ___qtablewidgetitem.setText(QCoreApplication.translate("processed_order_form", u"Order Id", None));
        ___qtablewidgetitem1 = self.orders_table.horizontalHeaderItem(1)
        ___qtablewidgetitem1.setText(QCoreApplication.translate("processed_order_form", u"Customer Name", None));
        ___qtablewidgetitem2 = self.orders_table.horizontalHeaderItem(2)
        ___qtablewidgetitem2.setText(QCoreApplication.translate("processed_order_form", u"Customer Address", None));
        ___qtablewidgetitem3 = self.orders_table.horizontalHeaderItem(3)
        ___qtablewidgetitem3.setText(QCoreApplication.translate("processed_order_form", u"Processed", None));
        ___qtablewidgetitem4 = self.orders_table.horizontalHeaderItem(4)
        ___qtablewidgetitem4.setText(QCoreApplication.translate("processed_order_form", u"Time Created", None));
        ___qtablewidgetitem5 = self.orders_table.horizontalHeaderItem(5)
        ___qtablewidgetitem5.setText(QCoreApplication.translate("processed_order_form", u"Completed", None));
        self.select_button.setText(QCoreApplication.translate("processed_order_form", u"Select", None))
        ___qtablewidgetitem6 = self.products_table.horizontalHeaderItem(0)
        ___qtablewidgetitem6.setText(QCoreApplication.translate("processed_order_form", u"Name", None));
        ___qtablewidgetitem7 = self.products_table.horizontalHeaderItem(1)
        ___qtablewidgetitem7.setText(QCoreApplication.translate("processed_order_form", u"Price", None));
        ___qtablewidgetitem8 = self.products_table.horizontalHeaderItem(2)
        ___qtablewidgetitem8.setText(QCoreApplication.translate("processed_order_form", u"Quantity ", None));
        self.clear_button.setText(QCoreApplication.translate("processed_order_form", u"Clear", None))
        self.total_price_label.setText(QCoreApplication.translate("processed_order_form", u"Total Price", None))
    # retranslateUi
